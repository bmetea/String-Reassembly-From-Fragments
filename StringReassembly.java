...
public final class StringReassembly {
    ...
    public static String combination(String str1, String str2, int overlap) {
        ...
        //take the substring of str2 excluding the first overlap amount
    ...
    public static Set<String> linesFromInput(SimpleReader input) {
        ...
        Set<String> returnSet = new Set1L<String>();
        //read in each line until an empty line is read
        while (!input.atEOS()) {
            //if that string is not already a substring within the set, add it
            String temp = input.nextLine();
            addToSetAvoidingSubstrings(returnSet, temp);
        }
        return returnSet;
    ...
    public static void printWithLineSeparators(String text, SimpleWriter out) {
        ...
        //replace all characters and print out the string
